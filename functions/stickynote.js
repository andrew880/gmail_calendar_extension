...
function resizeElem(e, t, n) {
    ...
    function r(t) {
        ...
        window.removeEventListener("mouseup", r, false)
    }
}
var helpers = {
    uuid_v4: function() {
    ...
    vwTOpx: function(e) {
        var t = window
          ...
          , r = t.innerHeight || o.clientHeight || i.clientHeight;
        var l = s * e / 100;
        return l
    },
    vhTOpx: function(e) {
...
var StickyNote = function(e, t) {
    ...
    s.addEventListener("click", function(e) {
        e.preventDefault();
        e.stopPropagation();
        if (window.storedNotes.length >= 30)
            return alert("Too many notes have been created.\nPlease delete some notes to resume.");
        var t = 0
          , n = 0;
        if (window.lastNote) {
    ...
    r.className = "stn-btn";
    r.innerHTML = "&#10006;";
    r.style.display = e && e.upset ? "" : "none";
    r.style.float = "right";
    ...
    c.addEventListener("contextmenu", function(e) {
        ...
        var s = e.clientY
          , r = e.clientX;
        if (e.clientY + n.offsetHeight > window.innerHeight)
            s = e.clientY - n.offsetHeight;
        if (e.clientX + n.offsetWidth > window.innerWidth)
            r = e.clientX - n.offsetWidth;
        n.style.top = s + "px";
        n.style.left = r + "px";
        o.contextMenus = n;
